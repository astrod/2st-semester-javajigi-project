...
public class LadderTest extends TestCase {
	...
	public void testLadder1() {
		assertEquals(6, obj.searchArray(1, map.getLadderObjectList()));
	}
	public void testLadder2() {
		assertEquals(4, obj.searchArray(2, map.getLadderObjectList()));
	}
	public void testLadder3() {
		assertEquals(5, obj.searchArray(3, map.getLadderObjectList()));
	}
	public void testLadder4() {
		assertEquals(1, obj.searchArray(4, map.getLadderObjectList()));
	}
	public void testLadder5() {
		assertEquals(2, obj.searchArray(5, map.getLadderObjectList()));
	}
	public void testLadder6() {
		assertEquals(3, obj.searchArray(6, map.getLadderObjectList()));
	}
	public void testLadder7() {
		assertEquals(-1, obj.searchArray(8, map.getLadderObjectList()));
	}
	public void testLadder8() {
		assertEquals(-1, obj.searchArray(-1, map.getLadderObjectList()));
	}
